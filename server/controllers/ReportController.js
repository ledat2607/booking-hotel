...
const ReportByType = require('../models/ReportByRoomType');
const RoomUsageDensityReport = require('../models/RoomUsageDensityReport');
...
module.exports = { getReports, createReportsModal, getReportByMonth };
